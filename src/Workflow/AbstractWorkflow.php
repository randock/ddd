...
abstract class AbstractWorkflow
{
     ...
     * @return bool
     */
    public function can($subject, string $transition)
    {
     ...
     */
    public function apply($subject, string $transition)
    {
     ...
     * @throws WorkflowException
     */
    private function guardApplyTransition($subject)
    {
     ...
     * @return mixed
     */
    private function getPlace($subject)
    {
     ...
     * @return string
     */
    private function getMethodNameProperty()
    {
